...
const {SupportedChainId} = require("@uniswap/sdk-core/dist/constants");
...
export const chainId = Number(process.argv.slice(3)[1]) //网络编号，由启动参数传来。
export const env = process.argv.slice(3)[2] //当前环境LOCAL, MAINNET, WALLET_EXTENSION
...
switch (chainId) {
    case SupportedChainId.MAINNET:
        exports.tokens = constant.tokensMAINNET
        break;
    case SupportedChainId.GOERLI:
        exports.tokens = constant.tokensGOERLI
        break;
    default:
