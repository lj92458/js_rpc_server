...
import {Environment, MAX_FEE_PER_GAS_GWEI, MAX_PRIORITY_FEE_PER_GAS_GWEI} from './constant.js'
...
export async function sendTransactionByWallet(transactionRequest, maxWaitSeconds, gasPriceGwei) {
    ...
    if (useSmartContractWallet) {
        transactionRequest = await smartContractWallet.populateTransaction.aggregate3Value([
                {
