...
import {MAX_FEE_PER_GAS, MAX_PRIORITY_FEE_PER_GAS, QUOTER_CONTRACT_ADDRESS, SWAP_ROUTER_ADDRESS,} from './constant.js'
import {getProvider, sendTransactionByWallet} from './providers.js'
...
export async function createTrade(provider, tokenIn, tokenOut, amountIn, needAmountOut, poolFee, slippage) {
    ...
    let decimalOutAmount = utils.formatUnits(outputQuote, tokenOut.decimals)
