...
/* 最大gas价格，100GW */
export const MAX_FEE_PER_GAS_GWEI = 1 //todo 不同的链，值不同. 单位：gwei
/* 最大加速gas价格，100GW */
...
export const pools = [//注意：不要调整数组中各元素的位置，否则下面routes会失效！！！
    ...
    {id: 9, goods: 'usdce', money: 'usdc', fee: 100, address: null},
]
...
export const routes = [
    ...
    [6, 9, 0],//usdt-usdce-usdc-usdt 费率0.03%
]
export const autoTradeInSymbol = 'usdt'//自动套利时的输入资金
export const autoTradeInAmount = 5000//自动套利时的输入资金数量
