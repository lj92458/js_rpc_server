...
import {chainId, provider, useSmartContractWallet, wallet} from "../config.js";
...
import {smartContractWalletAddress} from "./constant.js";
...
export async function addOrderFusion(coinPair, orderType, price, volume, maxWaitSeconds, gasPriceGwei, slippage) {
    ...
    try {
        ...
        let orderInfo = await sdk.placeOrder({//placeOrder会createOrder并submitOrder
            ...
            walletAddress: useSmartContractWallet ? smartContractWalletAddress : wallet.address,
        })
        return {
